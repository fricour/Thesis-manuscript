...
We used the same relationship to compute $F_{big}$ by replacing $slope_{w}$ as the sum of positive jumps (negative jumps were discarded) divided by the drifting time.
