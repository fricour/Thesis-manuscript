...
-   introduire le POC ici et introduire la BCP vite fait (classique)
-   dire que Chla = proxy pour phyto biomass
-   BGC-Argo floats are pseudo-lagrangian platforms
-   si on peut prouver que le diagramme ST, les massses d'eau sont les memes, alors on peut peut-être parler des ratios entre particlues à 500 et 1000 m
-   définir la méthode de calcul de la MLD
-   plotter la MLD sur les profils verticaux de
-   from llort 2017: This is especially true in the Southern Ocean, where the circulation has been described as equivalent barotropic (Gille et al., 2007; Killworth & Hughes, 2002). An equivalent barotropic circulation basically implies that the strength of the current might change with depth (weaker as depth increases) but the orientation does not change. Therefore, Argo and BGCArgo can be interpreted as "quasi-Lagrangian" because floats follow well ocean mesoscale circulation lasting more than 1 week; yet they cannot follow shorter and smaller features such the ones associated to submesocale circulation

Two pairs of Biogeochemical-Argo (BGC) floats were planned to be deployed at the time of the annual spring bloom in the Labrador Sea (LS). The latter is characterized by two bioregions with distinct phytoplankton bloom phelonogies on both side of the 60°N parallel [@Lacour2015-da]. The northern part is characterized by a short spring bloom in late April whereas the bloom in the southern part starts in April-May and slowly develops to reach its maximum in June [@Lacour2015-da]. In this study, two pairs of floats were deployed south of the 60°N parallel with a first couple (WMO 6904240 and 4903634) deployed closely to it (58.9°N) in late May 2022.
