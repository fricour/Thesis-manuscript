...
#| tbl-cap: Precision, recall and f1-score for each class and globally (lightgray background) in the UVP5 model (XGBoost and CNN). The abbreviation avg stands for average.
