...
From the data we feed models with to uncertainties caused by missing or poorly understood processes, current BCP models still disagree on the estimation of carbon export both currently and in response to climate change [@Henson2022-hg]. However, the ongoing increase in deployments of autonomous platforms and the development of new sensors is providing new opportunities to enhance the parametrization of key biogeochemical processes to better estimate carbon export and sequestration.
...
The BGC-Argo array has already demonstrated its ability to understand some aspects of the BCP [e.g. @Lacour2017-ro; @Lacour2019-id; @Briggs2020-gz; @Yang2021-vg; @Llort2018-pa; @Wang2022-hn]. However, the current array may lack some key data to further our understanding of the BCP. Therefore, other types of sensors could be added to help fill this gap.
...
1.  BGC-Argo floats equipped with a UVP6 and the zooplankton recognition algorithm are able to classify particles larger than 0.6 mm. However, these AUVs are limited in terms of their battery life. They are typically deployed for several years, which requires special attention to the energy consumption of each sensor. In @sec-uvp6, I will therefore describe the methodology used to develop the zooplankton classification model for the UVP6 accounting for energy limitations.
