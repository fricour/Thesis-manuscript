...
2.  Four BGC-Argo floats equipped with both a transmissometer and a UVP6 were deployed for the first time in the Labrador Sea in late May 2022 with the aim of observing POC export events due to the annual spring bloom. Unfortunately, it appears that the deployment occurred at the end of the spring bloom therefore we likely missed the major export events. In @sec-case-study-labrador-sea, I will therefore study the aftermaths of the spring bloom in terms of carbon fluxes estimated by both instruments. I will also compare the small (continuous) and big (stochastic) flux of particles as seen by transmissometers used as OSTs with PSDs measurements by UVP6s at three different drifting depths to investigate the relationship between the two instruments.
3.  Many studies have assumed that carbon sequestration only occurs in the deep ocean (typically 1000 m). In @sec-to-do, we reassess the global sequestration ($\geq$ 100 years) of the BCP and its components by using a continuous approach to carbon storage as opposed to the common view of long-term sequestration below a fixed reference depth.
