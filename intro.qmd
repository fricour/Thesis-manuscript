...
So far, we have seen that significant incertitudes remain in the estimations of the carbon export as well as the sequestration time by the different export pathways composing the BCP. To address this issue, biogeochemical models and observation tools are continuously being improved to further our understanding of the BCP (see @sec-modelling-observing-BCP).
