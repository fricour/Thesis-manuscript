...
#| fig-cap: Typical attenuation curve of the POC flux obtained with @eq-Martin-Curve. The color-coded layers represent regions with carbon-specific degradation rate, decreasing with depth. Figure inspired from @Iversen2022-qj.
